...
public class User
{
     ...
     * @param status    New status setting
     */
    ...
    // Task 1
    /**
     * Method to befriend another user, if not already a friend or ones' self
     * 
    ...
    /**
     * Method to check if a User has already been befriended
     * @param friend    User to be checked
     * @return          True if User is already a friend
     */
    ...
    /**
     * Method to display all messages for a specific subject
     * 
